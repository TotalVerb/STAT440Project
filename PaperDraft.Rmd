...
First, we observe that our computed value of $R_0$ in Italy matches what We observe that R_0 spikes in , with an early spike on February 27, potentially due to increased in testing, which captures cases before.
...
Observe that in many cities, our estimated $R_0$ values are extremely high 
